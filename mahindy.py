...
#         st.write(
#             "The following are the parameters that were used in this model: \nLearning_rate=0.0001,\n Epochs=5, \nLoss_function=categorical_crossentropy, \nBatch size=20, \nOptimizer=Adam, \nArchitecture=ViTModel")
